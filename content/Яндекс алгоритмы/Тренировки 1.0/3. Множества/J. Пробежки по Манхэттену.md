...
| Ввод                                                     | Вывод                         |
| -------------------------------------------------------- | ----------------------------- |
| ```<br>2 1 5<br>0 1<br>-2 1<br>-2 3<br>0 3<br>2 5<br>``` | ```<br>2<br>1 5<br>2 4<br>``` |

### Пример 2

| Ввод                       | Вывод                                                |
| -------------------------- | ---------------------------------------------------- |
| ```<br>1 1 1<br>0 0<br>``` | ```<br>5<br>-1 0<br>0 -1<br>0 0<br>0 1<br>1 0<br>``` |

### Пример 3

| Ввод                        | Вывод                                                |
| --------------------------- | ---------------------------------------------------- |
| ```<br>1 10 1<br>0 0<br>``` | ```<br>5<br>-1 0<br>0 -1<br>0 0<br>0 1<br>1 0<br>``` |
